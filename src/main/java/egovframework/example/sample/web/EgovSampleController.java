...
import egovframework.example.repository.SampleRepository;
...
public class EgovSampleController {
	...
	public SampleVO selectSample(SampleVO sampleVO, @ModelAttribute("searchVO") SampleDefaultVO searchVO) throws Exception {
		...
		try {
			...
			Optional<Sample> oSample = sampleRepository.findById(sampleVO.getId());
			
			Sample sample = oSample.get();
			
			
			vo.setId(sample.getId());
			vo.setName(sample.getName());
			vo.setDescription(sample.getDescription());
			vo.setRegUser(sample.getRegUser());
			vo.setUseYn(String.valueOf(sample.getUseYn()));
		} catch (Exception e) {
